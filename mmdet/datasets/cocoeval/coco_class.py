...
class COCO:
    ...
    def createIndex(self):
        ...
        self.bbox_intervals = None
        if "bbox_intervals" in self.dataset:
            self.bbox_intervals = self.dataset["bbox_intervals"]
    ...
    def loadRes(self, resFile, bbox_quality=[], bbox_metric='area'):
        """
        ...
        if 'caption' in anns[0]:
            ...
            for id, ann in enumerate(anns):
                ...
                ann['iscrowd'] = 0
                if eval_bbox:
                    ann[bbox_metric] = bbox_quality[id]
                elif bbox_metric == 'area':
                    ann[bbox_metric] = bb[2]*bb[3]
