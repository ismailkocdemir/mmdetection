...
img_norm_cfg = dict(
    mean=[107.32441277, 91.32513603, 88.79882435], std=[1090.51169599, 886.76499074, 894.24782345], to_rgb=True)
...
train_pipeline = [
    ...
    #dict(type='Normalize', **img_norm_255),
...
HDR_pipeline = [
    dict(type='LoadImageFromFile', to_float32=True, hdr=True, color_type='grayscale'),
    dict(
        type='MultiScaleFlipAug',
        img_scale=(1024, 576),
        flip=False,
