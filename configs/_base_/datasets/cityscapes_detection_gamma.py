...
img_norm_cfg = dict(
    mean = [47.03726407, 51.6239542,  47.24279113],
    std = [23.41052412, 24.05589198, 22.89025038],
    to_rgb=False)
train_pipeline = [
