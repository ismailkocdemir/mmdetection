...
img_norm_cfg = dict(
    mean = [73.32089887, 80.54264236, 73.80700724],
    std = [44.39102903, 46.83312552, 44.22370554],
    to_rgb=False)
train_pipeline = [
